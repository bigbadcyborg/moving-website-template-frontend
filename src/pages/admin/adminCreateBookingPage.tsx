...
export default function AdminCreateBookingPage() {
  ...
  // Get slots for selected day, filtered to business hours (8am - 6pm Central Time)
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Admin bookings use customer deposit amount</p>
            </div>
            <div>
