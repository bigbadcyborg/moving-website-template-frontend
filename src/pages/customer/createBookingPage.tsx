...
export default function CreateBookingPage() {
  ...
  const [formData, setFormData] = useState<QuoteInput & { customerName: string; customerEmail: string; customerPhone: string; notes: string }>(() => {
    ...
    return {
      ...
      fromStories: estimate?.fromStories || 1,
      fromElevator: estimate?.fromElevator || false,
      toStories: estimate?.toStories || 1,
      toElevator: estimate?.toElevator || false,
      requestedTrucks: estimate?.requestedTrucks || 1,
